...
import { ScratchpadNotes } from './scratchpad-notes';
import { provideToastr } from 'ngx-toastr';
import { provideAnimations } from '@angular/platform-browser/animations';

describe('ScratchpadNotes', () => {
  let service: ScratchpadNotes;

  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [ScratchpadNotes, provideToastr(), provideAnimations()], // or mock toastr
    });
    service = TestBed.inject(ScratchpadNotes);
  });
